...
- <i class="far fa-exclamation"></i> [Basics of clean code](/pages/general/clean-code)
- <i class="far fa-exclamation"></i> [Refactoring in action](/pages/general/refactoring-in-action)
